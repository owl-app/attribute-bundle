...
namespace Owl\Bundle\AttributeBundle\DependencyInjection\Compiler;
...
final class RegisterAttributeFactoryPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        foreach (array_keys($container->getParameter('sylius.attribute.subjects')) as $subject) {
            $oldAttributeFactory = $container->getDefinition(sprintf('owl.factory.%s_attribute', $subject));
            ...
            $container->setDefinition(sprintf('owl.factory.%s_attribute', $subject), $attributeFactoryDefinition);
        }
    }
}
